  ...
  head: () => ({
    meta: [
      ...
      { title: "Skill Binimoy — Learn. Teach. Grow Together." },
      {
        name: "description",
        content:
          "A premium skill-exchange platform where you learn from experts, teach what you know, and grow your reputation.",
      },
      { name: "theme-color", content: "#0056D2" },
      { property: "og:site_name", content: "Skill Binimoy" },
